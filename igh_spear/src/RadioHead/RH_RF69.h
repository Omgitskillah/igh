...
/// other spears demanding power. Inadequate power for the RF69 is likely to cause symptoms such as:
...
/// -spears hang Arduino boards, especially during the flashing
/// \par Interrupts
///
